      ...
      <div className="repo-card-div" key={repo.node.id} onClick={() => openRepoinNewTab(repo.node.url)}>
        ...
        <div className="repo-stats">
          <div className="repo-left-stat">
            <span>
            {repo.node.primaryLanguage && <div className="language-color" style={{ backgroundColor: repo.node.primaryLanguage.color }}></div>}
            {repo.node.primaryLanguage && <p>{repo.node.primaryLanguage.name}</p>}
            </span>
            <span>
